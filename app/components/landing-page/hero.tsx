    ...
    <section className="container py-20 md:py-32">
      <div className="mx-auto text-center space-y-6">
        ...
        <p className="text-xl text-muted-foreground md:w-10/12 mx-auto">
          <Balance>
            Join startups and enterprises in transforming their user engagement
            with Chatmate’s AI-powered chatbot. Experience a seamless
            integration and boost your conversion rates.
          </Balance>
        </p>
