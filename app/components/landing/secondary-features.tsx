...
const features: Feature[] = [
  {
    name: "Intuitive engagement",
    summary:
      "Engage your customers with relevant follow-up questions generated by AI.",
    description:
      "AI-driven follow-ups crafted from previous chat histories, ensuring relevance and smoothness in customer interactions.",
    image: screenshotFollowup,
    ...
    <Tab.Group as="div" className="hidden lg:mt-20 lg:block">
      {({ selectedIndex }) => (
        <>
          ...
          <Tab.Panels className="relative mt-20 overflow-hidden rounded-4xl bg-muted px-14 py-16 xl:px-16 rounded-xl">
